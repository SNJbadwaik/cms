...
function GetAllCustomerCouriers() {
  ...
  const fetchdata = () => {
    ...
    axios
      .get(config.serverURL + `/customer/getallcouriers/${id}`)
      .then((response) => {
      ...
      <div className="container">
        ...
        <div>
          <button className="btn btn-danger">
            <Link className="text-decoration-none text-dark" to="/customerHome">
              BACK
            </Link>
          </button>
        </div>
...
export default GetAllCustomerCouriers;
